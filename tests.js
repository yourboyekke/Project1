...
function toggleTests() {
    document.getElementById('testconfig').hidden = !document.getElementById('testconfig').hidden
}

config.intro && describe(`შესავალი და თავდაპირველი ფუნქციონალის შემოწმება. 
    `, () => {
    ...
    it.skip(`ფუნქციონალის ნაწილი მოითხოვს ნასწავლი მასალის გამოყენებას ახალი გზით. ზოგი 
            მოითხოვს საჭირო მასალის დამოუკიდებლად მოძიებას და სწავლას. ასეთი დავალებები აღნიშნულია
            *-ით`)
...
config.posts && describe(`10 ქულა. პოსტები`, () => {
    const tester = new Tester()
    describe(`ui/ux დამატებები`, () => {
        ...
        it(`2 ქულა. თუ პოსტს არ აქვს არცერთი ლაიქი, ${testConfig.postLikesText} 
    ...
    describe(`თარიღის შენახვა *`, () => {
        it(`2 ქულა. პოსტის ობიექტს აქვს ატრიბუტი date, რომლის
        ...
        it(`2 ქულა.  ფიდში ${testConfig.post} ელემენტს 
...
config.comments && describe(`10 ქულა. კომენტარები`, () => {
    const tester = new Tester()
...
config.news_feed && describe(`5 ქულა. news feed`, () => {
    // it.skip(``)
    ...
    function getDate(day, month, year, time) {
        return new Date(`${month} ${day} ${year} ${time} GMT+0400 (Georgia Standard Time)`)
    }
    it(`5 ქულა. * ორმაგი ფილტრი. პოსტები უნდა იყოს დალაგებული 
